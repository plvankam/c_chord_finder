...
void makeChordArray(char* array, uint8_t* cArray, char* errArray)
{
  ...
  else if (!strcmp(array,"C#") ||  !strcmp(array,"Db")){
    for (i=0;i<ARRAY_LEN;++i){
      switch(i)
      {
  ...
  else if (!strcmp(array,"D#") || !strcmp(array,"Eb")){
    for (i=0;i<ARRAY_LEN;++i){
      switch(i)
      {
  ...
  else if (!strcmp(array,"F#") || !strcmp(array,"Gb")){
    for (i=0;i<ARRAY_LEN;++i){
      switch(i)
      {
  ...
  else if (!strcmp(array,"G#") || !strcmp(array,"F")){
    for (i=0;i<ARRAY_LEN;++i){
      switch(i)
      {
  ...
  else if (!strcmp(array,"A#") || !strcmp(array,"Bb")){
    for (i=0;i<ARRAY_LEN;++i){
      switch(i)
      {
  ...
  else if (!strcmp(array,"g#") || !strcmp(array,"ab") ){
    for (i=0;i<ARRAY_LEN;++i){
      switch(i)
      {
